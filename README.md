# Poople-Solver
I saw a funny game today called the **Poople**. It reminded me of a leetcode I'd done recently and so I was inspired to make this solver based on the connected graph components of the words available in the game.

Since it's been a few weeks since I've done anything C++ related I wanted to just build something fun that challenged my brain a little after work, so I decided to built this. 
